...
const DEFAULT_PRESETS = [
  { label: 'Sikkim Mountains Banner', url: sikkimHeroBanner },
  { label: 'Darjeeling Tea Gardens', url: darjeelingTeaGardens },
  { label: 'Zero Point & Snow Peaks', url: yumthangZeroPoint },
  { label: 'Ravangla Buddha Park', url: ravanglaBuddhaPark },
  { label: 'Luxury Innova Mountain Cab', url: innovaCrystaCab },
  { label: 'Offbeat Dark Travel Poster', url: agencyPosterDark },
];
