...
export { SIKKIM_TOUR_FAQS } from './faqData';
...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    highResUrl: darjeelingTeaGardens,
  ...
  },
  {
    ...
    highResUrl: innovaMountainDrive,
  ...
  // -------------------------------------------------------------
  {
    ...
    type: "photo",
    url: agencyPosterDark,
    highResUrl: agencyPosterDark,
  ...
  },
  {
    ...
    type: "photo",
    url: googleReviewBadge,
    highResUrl: googleReviewBadge,
